...
public class MonthlyStatmentController {
    ...
    public MonthlyStatementDto generateStatementupdate(@RequestBody @Valid  MonthlyStatementDto request, @PathVariable  String month, @PathVariable String upToDate) {
